...
const Modal: React.FC<{
    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-start justify-center z-50 p-4 pt-16" role="dialog" aria-modal="true">
...
const CertificateSVG: React.FC<{ data: CertificateData }> = ({ data }) => {
    const { t } = useLocalization();
    const logoPath = "M12 2a10 10 0 100 20 10 10 0 000-20zm0 18a8 8 0 110-16 8 8 0 010 16zM11 7h2v6h-2V7zm0 8h2v2h-2v-2z";
