...
const AboutPage: React.FC = () => {
  ...
  return (
    ...
    <div className="bg-base-50 dark:bg-base-950 transition-colors duration-500">
      <section className="bg-primary-600 dark:bg-primary-700 text-white py-24">
        <div className="container mx-auto px-4 text-center">
          <p className="text-[12px] font-black uppercase tracking-[0.5em] mb-4 text-primary-200 dark:text-primary-100">The Human Story</p>
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter">Rooted in Kindness</h1>
          <p className="mt-8 text-xl max-w-3xl mx-auto text-primary-100 dark:text-primary-50 font-medium">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="flex justify-center">
            <div className="p-16 bg-base-50 dark:bg-base-900 rounded-[4rem] shadow-2xl relative border border-base-100 dark:border-base-800">
      ...
      <section className="py-24 bg-base-100 dark:bg-base-900/50">
        <div className="container mx-auto px-4 max-w-5xl text-center">
            ...
            <div className="grid md:grid-cols-3 gap-12 text-left">
                <div className="p-10 bg-base-50 dark:bg-base-900 rounded-[3rem] border border-base-200 dark:border-base-800">
                    <h3 className="font-black text-primary-500 dark:text-primary-400 text-xl mb-4 uppercase tracking-tighter">Legacy</h3>
                ...
                <div className="p-10 bg-base-50 dark:bg-base-900 rounded-[3rem] border border-base-200 dark:border-base-800">
                    <h3 className="font-black text-primary-500 dark:text-primary-400 text-xl mb-4 uppercase tracking-tighter">Impact</h3>
                ...
                <div className="p-10 bg-base-50 dark:bg-base-900 rounded-[3rem] border border-base-200 dark:border-base-800">
                    <h3 className="font-black text-primary-500 dark:text-primary-400 text-xl mb-4 uppercase tracking-tighter">Vision</h3>
      ...
      <section className="py-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-base-600 dark:text-base-400 max-w-2xl mx-auto mb-12 font-medium">
