...
const TodayFocus: React.FC<TodayFocusProps> = ({
  ...
  return (
    <section className="bg-white/60 dark:bg-base-900/60 backdrop-blur-md p-6 sm:p-8 rounded-2xl shadow-soft border border-base-200 dark:border-base-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        {(['happy', 'neutral', 'sad'] as const).map(mood => (
                            <button
                                ...
                                className={`flex-1 py-3 px-2 rounded-xl border-2 transition-all flex flex-col items-center gap-1 ${
                                    ...
                                    : 'bg-white dark:bg-base-800 border-base-200 dark:border-base-700 text-base-600 dark:text-base-300 hover:border-primary-300'
                                }`}
                            >
            ...
            <div className="flex flex-col justify-center p-6 bg-base-50 dark:bg-base-950/30 rounded-xl border border-base-100 dark:border-base-800">
                <div className="text-center">
                    ...
                    <button onClick={onStartJournal} className="inline-block px-8 py-3 bg-base-800 text-white dark:bg-base-100 dark:text-base-900 rounded-full font-bold text-sm hover:opacity-90 transition-opacity">
